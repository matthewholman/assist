...
class TestAssistASCII(unittest.TestCase):
    ...
    def test_holman(self):
        ...
        self.assertLess(math.fabs(d.x*au2meter), 0.1) 
        self.assertLess(math.fabs(d.y*au2meter), 0.1) 
        self.assertLess(math.fabs(d.z*au2meter), 0.1) 
        self.assertLess(math.fabs(d.vx*au2meter), 5e-3) 
        self.assertLess(math.fabs(d.vy*au2meter), 5e-3) 
        self.assertLess(math.fabs(d.vz*au2meter), 5e-3) 
